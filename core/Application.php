...
class Application
{
    ...
    public static function execute($error_code = false)
    {
        try {
            ...
            self::$main_domain = self::$protocol . 'www.georostgrupp.ru';
            self::$main_domain_short = 'www.georostgrupp.ru';
            ...
            include_once Core::$classes_path . 'DeviceDetect.php';
            ...
            self::$device_code = DeviceDetect::getDeviceType();
