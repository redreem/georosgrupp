...
class AboutView extends AbstractView
{
    ...
    {
        $t = new Template(Core::$config['template_root'] . 'about' . DIRECTORY_SEPARATOR . 'feedback.phtml');
        $this->content = $t->render();
    }

    public function sended()
    {
        $t = new Template(Core::$config['template_root'] . 'about' . DIRECTORY_SEPARATOR . 'sended.phtml');
        $this->content = $t->render();
    }
}